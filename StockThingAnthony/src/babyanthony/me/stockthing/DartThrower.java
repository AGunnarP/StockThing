...
import babyanthony.me.stockthing.math.StatMath;
	...
	public static Decision scanStock(Connection myConnection, String symbol) {
		...
		try {
			...
			stmt = myConnection.createStatement();
				...
				double mean = StatMath.getMean(data);
				double Sx = StatMath.getStandardDeviation(data, mean);
				double zScores[] = StatMath.getZscores(data, mean, Sx);
